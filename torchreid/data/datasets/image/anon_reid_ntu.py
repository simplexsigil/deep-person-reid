...
class AnonymizedReIDNTU(ImageDataset):
    ...
    def __init__(self, root="", max_samples_per_person=100, **kwargs):
        ...
        # Modified pattern for NTU dataset format
        # S017C003P020R002A047_rgb.jpg -> capture C003 and P020
        pattern = re.compile(r".*C\d{3}P(\d{3}).*\.jpg")
        ...
        super(AnonymizedReIDNTU, self).__init__(train, query, gallery, **kwargs)
